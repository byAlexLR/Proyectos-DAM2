...
# 3. Crear una clase banco, iniciando la variable saldo y la cuenta en la que aparece. Además, de se ha sacado o ingresado dinero.
...
while True:
    ...
    tipo_cuenta = input("\nBienvenido al servicio bancario. ¿A qué cuenta desea acceder?\n1.Ahorro\n2.Jubilación\n3.Corriente\n4.Salir\nSeleccione una opción: ")
